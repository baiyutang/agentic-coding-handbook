...
- **代表：** [AWS Q Developer](https://aws.amazon.com/q/developer/) ·
  ...
  [CodeBuddy](https://www.codebuddy.ai)（腾讯云）·
  [Qoder](https://lingma.aliyun.com)（阿里云；国内版 Qoder CN，前身通义灵码）
...
| [CodeBuddy](https://www.codebuddy.ai) | 云厂商 | 专有 | DeepSeek + 混元 | 免费–¥198/用户/月 | 腾讯云；支持 VS Code、JetBrains、微信开发者工具 |
| [Qoder](https://lingma.aliyun.com) | 云厂商 | 专有 | 通义 + 其他 | Credits 制 | 阿里云；桌面+CLI+IDE；国内版 Qoder CN & 国际版 |
...
| 国内数据驻留 / 合规 | Qoder（国内版）、CodeBuddy |
| 完全自主处理 issue | 自主平台（OpenHands、Goose） |
