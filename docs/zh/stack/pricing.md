...
| [Qoder](https://lingma.aliyun.com) | 有 | Credits 制 | Credits + VPC 方案 | 按席位 / Credits | [定价](https://lingma.aliyun.com/lingma/pricing) |
...
| [阿里云百炼](https://bailian.aliyun.com) | 通义系列 + 第三方 | 按输入长度分级计费；批量折扣 | 国内合规；与 Qoder 打通 | [定价](https://help.aliyun.com/zh/model-studio/model-pricing) |
...
- **模型分层** —— 规划用顶级模型，编码用中级，补全用快速/廉价模型。详见[模型选择与成本](/zh/stack/models)。
